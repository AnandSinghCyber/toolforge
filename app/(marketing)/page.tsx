      ...
      <section className="py-20 text-center">
        <Container>
          ...
          <p className="mx-auto mt-6 max-w-3xl text-lg text-muted-foreground">
            Use free online developer tools including JSON Formatter,
            JSON Validator, SHA256 Generator, SHA1 Generator, MD5 Generator,
            UUID Generator, Base64 Encoder & Decoder, JWT Decoder,
            Unix Timestamp Converter, HTTP Header Parser and URL Encoder.
            Fast, secure and privacy-friendly — no signup required.
          </p>
          ...
          <div className="space-y-6 max-w-3xl">
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                Yes. All tools on ToolForge are completely free to use with no signup required.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                No. All tools run entirely in your browser. We do not store your input data.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                Yes. All processing happens client-side using secure browser APIs.
              </p>
            </div>
          </div>
        </Container>
